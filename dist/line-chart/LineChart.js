        ...
        return (<View style={style}>
            <Svg height={height + paddingBottom + legendOffset} width={width - margin * 2 - marginRight}>
                ...
                <G x="0" y={legendOffset}>
                    <Rect width="100%" height={height - 40} x={65} rx={borderRadius} ry={borderRadius} fill="url(#backgroundGradient)" fillOpacity={transparent ? 0 : 1} />
                    <G>
                    ...
                    <G>
                        {withVerticalLabels &&
                            this.renderVerticalLabels(__assign(__assign({}, config), { x:this.props.x,y:this.props.y,labels: labels, paddingTop: paddingTop, paddingRight: paddingRight, formatXLabel: formatXLabel }))}
                    </G>
                    <G>
